...
# V80 uses an unversioned bd_lib layout (single copy of each tcl).
# The $version argument is retained for signature-compatibility with the
# u250 helper but is not part of the path.
proc get_bd_lib_file { script_folder filename version } {
  return $script_folder/bd_lib/$filename
}
