...
# Cleanup
delete_files [list ${root_dir}/vivado_proj/firesim.pdi]
...
if {[file exists [set constrFile [retrieveVersionedFile ${root_dir}/design/FireSim-generated.implementation.xdc $vivado_version]]]} {
    ...
    add_line_to_file 1 $constrFile "create_generated_clock -name host_clock \[get_pins design_1_i/clk_wizard_0/inst/clock_primitive_inst/MMCME5_inst/CLKOUT0\]"
...
if {[file exists [set constrFile ${root_dir}/design/v80_ddr4_pins.xdc]]} {
    add_files -fileset impl_fileset -norecurse $constrFile
}
