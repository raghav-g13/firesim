...
proc create_root_design { parentCell } {
  ...
  set_property -dict [list \
    CONFIG.CPM_CONFIG { \
      ...
      CPM_PCIE0_PF0_PCIEBAR2AXIBAR_QDMA_0 {0x0000020200000000} \
      CPM_PCIE0_PF0_PCIEBAR2AXIBAR_QDMA_1 {0x0000020180000000} \
      ...
      CPM_PCIE0_PF1_SRIOV_VF_DEVICE_ID {C148} \
      ...
      CPM_PCIE0_PF2_SRIOV_VF_DEVICE_ID {C248} \
      ...
      CPM_PCIE0_PF3_SRIOV_VF_DEVICE_ID {C348} \
  ...
  connect_bd_net -net versal_cips_0_dma0_axi_aresetn [get_bd_pins versal_cips_0/dma0_axi_aresetn] [get_bd_ports dma0_axi_aresetn_0] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins pcie_qdma_mailbox_0/axi_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins smartconnect_1/aresetn] [get_bd_pins pcie_qdma_mailbox_0/ip_resetn]
  connect_bd_net -net versal_cips_0_pl0_user_clk [get_bd_pins versal_cips_0/pl0_ref_clk] [get_bd_ports dma0_intrfc_clk_0] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk] [get_bd_pins axi_noc_0/aclk2] [get_bd_pins pcie_qdma_mailbox_0/axi_aclk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins smartconnect_1/aclk] [get_bd_pins versal_cips_0/dma0_intrfc_clk] [get_bd_pins pcie_qdma_mailbox_0/ip_clk]
